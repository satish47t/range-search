...
def request(host, path, url_params=None):
    ...
    url = u"https://{0}{1}?".format(host, urllib.quote(path.encode('utf-8')))
    #url = 'http://{0}{1}?{2}'.format(host, urllib.quote(path.encode("utf8")), encoded_params)
